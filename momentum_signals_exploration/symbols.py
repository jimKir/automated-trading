...
def get_sp500_symbols() -> List[str]:
    ...
    return [
        ...
        # Healthcare
        'JNJ', 'UNH', 'PFE', 'ABBV', 'MRK', 'TMO', 'LLY', 'CVS',
        # Industrials
        'BA', 'CAT', 'GE', 'MMM', 'RTX', 'LMT', 'HON', 'ROK',
        # Energy
        'XOM', 'CVX', 'COP', 'MPC', 'PSX', 'OKE', 'SLB', 'FANG',
        # Consumer
        'WMT', 'COST', 'HD', 'TGT', 'LOW', 'MCD', 'NKE', 'SBUX',
        # Real Estate
        'PLD', 'DLR', 'EQIX', 'WELL', 'AVB', 'PTC', 'ARE', 'PSA',
        # Utilities
        'NEE', 'DUK', 'SO', 'D', 'EXC', 'LNT', 'AEP', 'XEL',
        # Communication
        'VZ', 'T', 'CMCSA', 'CHTR', 'TMUS',
        # Materials
        'LIN', 'APD', 'SHW', 'NUE', 'IP', 'KIM', 'FCX', 'CF',
        # Semiconductors
        'AMD', 'QCOM', 'AVGO', 'MU', 'INTC', 'MCHP', 'NXPI', 'KLAC',
        # Software
        'CRM', 'ADBE', 'ORCL', 'SAP', 'SNOW', 'ZOOM', 'OKTA', 'DDOG',
        # Additional liquid names
        'PG', 'KO', 'PEP', 'CSCO', 'IBM', 'ACN', 'SYK', 'ISRG',
        'AXP', 'INTU', 'AMAT', 'ASML', 'LRCX', 'ADI', 'TXN', 'SWKS',
...
def get_nasdaq100_symbols() -> List[str]:
    ...
    return [
        'AAPL', 'MSFT', 'NVDA', 'GOOGL', 'META', 'AMZN', 'TSLA', 'ASML',
        'AVGO', 'AMAT', 'AMD', 'ADSK', 'ADP', 'ABNB', 'ALTERA',
        'ANSS', 'ASHR', 'ADI', 'ADBE', 'ARM', 'ANET',
        'BIDU', 'BIIB', 'BLKC', 'BKNG',
        'CDNS', 'CERNER', 'CHKP', 'CHWY', 'CRM', 'CSCO', 'COIN', 'CCXI', 'CSGP',
        'CTSH', 'CMCSA', 'CSX', 'CPRT', 'CRWD',
        'DDOG', 'DLTR', 'DXC', 'DPZ',
        'EBAY', 'EXC', 'EXPE', 'EXEQ',
        'FAST', 'FISV', 'FTNT', 'FTCH',
        'GILD', 'GOOG', 'GRMN', 'GLAYF', 'GRUB',
        'HCAT', 'HSTM', 'HSIC', 'HUBB', 'HWKN', 'HYLN',
        'ILMN', 'INTU', 'INTC', 'INMD', 'IONQ',
        'JBLU', 'JKHY', 'JCOM',
        'KLAC', 'KDP', 'KEYS',
        'LRCX', 'LOGI', 'LILM', 'LYV',
        'MARVL', 'MASTR', 'MCHP', 'MDLZ', 'MRNA', 'MNST', 'MSFT', 'MU', 'MXIM',
        'NFLX', 'NXPI', 'NVDA', 'NEON',
        'ODFL', 'OKTA', 'ORCL',
        'PAYX', 'PCAR', 'PENN', 'PKOH', 'PYPL', 'PEP', 'PSEC', 'PLTR',
        'QCOM', 'QRVO',
        'RVNC', 'RBLX', 'ROIV', 'ROKU', 'ROST',
        'SAIC', 'SGEN', 'SIRI', 'SMCI', 'SPLK', 'SNOW', 'SNPS', 'STWD', 'SWKS',
        'TEAM', 'TMDX', 'TDOC', 'TLIS', 'TMUZ', 'TTEK', 'TROW', 'TSLA', 'TWTR', 'TXNN', 'TTD',
        'UBER', 'ULTA',
        'VRSN', 'VRSK', 'VRTX',
        'WDAY', 'WDRV', 'WERN', 'WKME', 'WUSH',
        'XCEL', 'XONC',
        'YEXT',
        'ZLAB', 'ZOOM', 'ZSCALER',
    ]
...
def get_all_symbols() -> List[str]:
    ...
    additional = [
        # Mid-caps
        'AFRM', 'BGFV', 'BOOT', 'BURL', 'CATO', 'CBRL', 'CELH', 'CFLT',
        'CHPT', 'CLPS', 'CSGP', 'DASH', 'DENN', 'DKNG', 'DMTK', 'DOCU',
        'DOMO', 'DOOR', 'DOORDASH', 'DUKEMI', 'DUOL', 'EAT', 'ELEV',
